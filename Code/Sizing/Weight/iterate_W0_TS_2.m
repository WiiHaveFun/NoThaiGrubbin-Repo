...
function [ac, flag] = iterate_W0_TS_2(ac, Wfrac_reg, mission_fun, T0, S)
...
options = optimoptions("fsolve", "Display", "final", "Algorithm", "trust-region-dogleg");
if isequal(mission_fun, @a2a_Ffrac)
    [ac.a2a.W0, ~, flag, ~] = fsolve(@(W0) W0_residual(ac, Wfrac_reg, mission_fun, T0, S, W0), 1.0.*ac.a2a.W0, options);
