...
Wfracs = [Wfracs, Wfrac];
% h1 = get_cruise_start_h(ac, Wfrac, ac.a2a.W0, 0, ac.polar.clean, false, ac.a2a.cruise_pp);
h1 = ac.initial.h_cruise;
[Wfrac_climb, d_climb] = climb_ref_Wfrac(ac, Wfrac, ac.a2a.W0, 0, h1, ac.polar.clean, false);
Wfrac = Wfrac .* Wfrac_climb;

% Cruise climb to combat
segments = [segments, "cruise_1"];
Wfracs = [Wfracs, Wfrac];
[Wfrac_cruise, ~, ~] = cruiseclimb_Wfrac(ac, Wfrac, ac.a2a.W0, ac.a2a.R - d_climb, ac.polar.clean, ac.polar.cruise_pp);
...
Wfracs = [Wfracs, Wfrac];
% h1 = get_cruise_start_h(ac, Wfrac, ac.a2a.W0, ac.a2a.h_combat, ac.polar.clean, false, ac.a2a.cruise_pp);
h1 = ac.initial.h_cruise;
[Wfrac_climb, d_climb] = climb_ref_Wfrac(ac, Wfrac, ac.a2a.W0, ac.a2a.h_combat, h1, ac.polar.clean, false);
Wfrac = Wfrac .* Wfrac_climb;
