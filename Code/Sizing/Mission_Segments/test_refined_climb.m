...
tic
[ac] = iterate_W0_TS_ref(ac, Wefrac_reg, @a2a_ref_Ffrac, ac.initial.T_max, ac.initial.Sref);
[ac] = iterate_W0_TS_ref(ac, Wefrac_reg, @strike_ref_Ffrac, ac.initial.T_max, ac.initial.Sref);
toc
